...
} catch (error) { console.log(`[ERROR] Failed to Load Events: ${error.toString().substring(7)}`) }
...
} catch (error) { console.log(`[ERROR] Failed to Load Autocomplete Interactions: ${error.toString().substring(7)}`) }
...
} catch (error) { console.log(`[ERROR] Failed to Load Button Interactions: ${error.toString().substring(7)}`) }
...
} catch (error) { console.log(`[ERROR] Failed to Load Modal Interactions: ${error.toString().substring(7)}`) }
...
} catch (error) { console.log(`[ERROR] Failed to Load Select Menus Interactions: ${error.toString().substring(7)}`) }
